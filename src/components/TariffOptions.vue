<template>
  <div class="options-checkboxes">
      <div class="options-checkboxes__header">
        ...
        <div class="options-checkboxes__selection-reset tooltip">
      ...
      <div class="options-checkboxes__option">
        <input type="checkbox" name="only-direct" id="only-direct" v-model="direct" @change="returnDirect">
        <label for="only-direct">Только прямые</label>
      </div>
      <div class="options-checkboxes__option">
        <input type="checkbox" name="only-with-baggage" id="only-with-baggage" v-model="baggage" @change="returnBaggage">
        <label for="only-with-baggage">Только с багажом</label>
      </div>
      <div class="options-checkboxes__option">
        <input type="checkbox" name="only-refundable" id="only-refundable" v-model="refundable" @change="returnRefundable">
